...
func configVars() *seq {
	vars := []configVar{
		...
		{Name: "MIXER_SOLE_CLOCK", Default: "false", Description: "When true, WS/agent ingress blocks for real PCM instead of Sleep-pacing or inventing silence. Pair with a deeper MIXER_LIVE_QUEUE_DEPTH."},
		{Name: "MIXER_LIVE_QUEUE_DEPTH", Default: "3", Description: "AddParticipant incoming/outgoing channel depth."},
		{Name: "COMFORT_NOISE_ENABLED", Default: "true", Description: "Inject low-level comfort noise (~-75 dBFS) into silent mixer frames."},
