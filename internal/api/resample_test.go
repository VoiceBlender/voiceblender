...
// TestLegPlaybackWriter_NoSeamDiscontinuity drives consecutive 20 ms frames of a
// continuous sine through the real legPlaybackWriter.Write and asserts every
// frame comes out whole. This is the guard against per-frame resampler
// construction, which zeroes the filter and gaps the head of every frame while
// still passing the duration and attenuation checks.
