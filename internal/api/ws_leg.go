...
// applyWSJitterBuffer stamps the server-wide WS ingress playout lead onto cfg.
// Operator-tuned only, with no per-request override, matching how
// SIP_JITTER_BUFFER_MS applies to every SIP leg.
